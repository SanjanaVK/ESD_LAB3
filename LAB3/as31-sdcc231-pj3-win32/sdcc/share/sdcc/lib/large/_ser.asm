...
;------------------------------------------------------------
;tmp                       Allocated to in memory with name '_ser_getc_tmp_1_1'
;	_ser.c 121
;	-----------------------------------------
;	 function ser_getc
;	-----------------------------------------
...
;------------------------------------------------------------
;String                    Allocated to in memory with name '_ser_printString_String_1_1'
;	_ser.c 138
;	-----------------------------------------
...
;------------------------------------------------------------
;ret                       Allocated to in memory with name '_ser_charAvail_ret_1_1'
;	_ser.c 146
;	-----------------------------------------
